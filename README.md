...
<img src='http://i.imgur.com/18qKV4t.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
- [StaggeredGridView](https://github.com/f-barth/AndroidStaggeredGrid) - Library for displaying grid items in a way that minimizes white space
- [TouchImageView](https://github.com/MikeOrtiz/TouchImageView) - Allows basic zooming and panning on images
